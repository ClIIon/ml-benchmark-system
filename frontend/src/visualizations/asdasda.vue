<template>
  <div id="app">
    <h1>机器学习 Benchmark 系统</h1>
    <BenchmarkControls @run="handleRun" />

    <div v-if="loading" class="progress">
      <el-progress :percentage="progressPercent" :text-inside="true" status="active" />
      <p>{{ progressStatus }}</p>
    </div>
    ...
    <DynamicMetricsChart
      v-if="results && results.task !== 'dim_reduction'"
      :task="results.task"
